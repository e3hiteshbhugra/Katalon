...
WS.verifyElementText(capitalResponse, 'CapitalCityResponse.CapitalCityResult', countryCapital)

currencyResponse = WS.sendRequest(findTestObject('CountryInfoSoapService/GetCurrency', ['CountryIsoCode' : countryCode]))

WS.verifyElementText(currencyResponse, 'CountryCurrencyResponse.CountryCurrencyResult.sName', countryCurrency)